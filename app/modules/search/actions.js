...
export function createrestaurant(user, successCB, errorCB) {
    return (dispatch) => {
        api.createrestaurant(user, function (success, data, error) {
            if (success) {
                successCB(user);
            }else if (error) errorCB(error)
        });
...
export function createhotel(user, successCB, errorCB) {
    return (dispatch) => {
        api.createhotel(user, function (success, data, error) {
            if (success) {
                successCB(user);
            }else if (error) errorCB(error)
        });
...
export function createproduct(user, successCB, errorCB) {
    return (dispatch) => {
        api.createproduct(user, function (success, data, error) {
            if (success) {
                successCB(user);
            }else if (error) errorCB(error)
        });
