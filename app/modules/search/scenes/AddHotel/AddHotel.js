...
import Form from "../../components/FormHotel"
import styles from "./style"
import { actions as auth, theme } from "../../../search/index"
const { signOut, createhotel} = auth;
const { color } = theme;
...
class AddHotel extends React.Component {
    ...
    onSubmit(data) {
        ...
        this.props.createhotel(data, this.onSuccess, this.onError)
    }
    ...
    onSuccess() {
        ...
        Actions.pop()
        alert("Please take note our staff will confirm your hotel information very soon.")
    }
...
export default connect(mapStateToProps,{ signOut, createhotel })(AddHotel);